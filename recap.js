/**
  ...
  4. get and set value from a dom element
     4-1: use innerText (h1, p, h5, div, span, strong)
     4-2: use value (input, textArea)

  5. add event listener (click handler)
    5-1: click, focus, blur, onchange, keyup
    5-2: addEventListener onclick="myHandler()"

  6. use function to reduce duplicate code

  7. event bubble delegate
 */

document.querySelectorAll('.user_container .disable h3')
document.querySelectorAll('.my_users li')
